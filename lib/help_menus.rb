...
def user_help_menu
  puts "------------------------------------------------------------------"
  puts "1. list all companies                    companies listed in database"
  ...
  puts "7. list all analysts                     analysts in database"
  puts "8. list my analysts                      lists analysts you follow"
  puts "9. add analyst                           follow an analyst from the list"
  puts "10. create analyst                        add an analyst to the list and follow them"
  puts "11. delete analyst                       unfollow an analyst"
  puts "12. help                                 lists commands available"
  puts "13. logout                               log out of this account"
  puts "------------------------------------------------------------------"
end
